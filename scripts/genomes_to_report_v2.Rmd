...
Mlst automatically detects the best scheme for typing. If you don't agree with the automatic detection, you can enforce a scheme by running assemblycomparator2 with `--config mlst_scheme=hpylori`. Replace *hpylori* with the mlst scheme you wish to use. You can find a full list of available schemes in the output directory in "mlst/mlst_schemes.txt".
