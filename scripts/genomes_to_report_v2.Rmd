...
The core genome phylogeny is provided with [FastTree](http://www.microbesonline.org/fasttree/) with the generalized time-reversible (GTR) model of nucleotide evolution. The plotted tree is midpoint rooted.
...
SNP-distances between the core gene alignments. Calculated with [snp-dists](https://github.com/tseemann/snp-dists#snp-dists)
