...
Assembly statistics provided by [Sanger-pathogens' assembly-stats](https://github.com/sanger-pathogens/assembly-stats#assembly-stats).
...
Multi locus sequence typing provided by [Torsten Seemanns mlst](https://github.com/tseemann/mlst#mlst).
```{r echo=FALSE, message=F, warning=F}
...
## NCBI Resistance
Resistance genes provided by [NCBI AMRFinder](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6811410/) via [Torsten Seemanns Abricate](https://github.com/tseemann/abricate#abricate).
...
#### The assemblycomparator2 pipeline and this report was developed by Oliver Hansen & Carl M. Kobel
