...
*Fig. `r figno()`: Lengths of contigs (fasta records) for each sample. The colors - only available when there is a maximum of ten contigs per sample - have no intrinsic meaning, other than highlighting the decreasing size of contigs/records in assemblies.*
