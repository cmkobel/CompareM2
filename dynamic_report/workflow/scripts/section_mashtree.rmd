...
```{r mashtree-pdf, echo=FALSE, message=F, warning=F, error = T}
# Plot again, and save to disk

invisible({
    pdf(paste0(output_directory, "/visuals/", paste(batch_title, "mashtree", sep = "__"), ".pdf")) 
    ape::plot.phylo(tree, align.tip.label = T, font = 1, cex = 0.73)
    axis(1)
    dev.off() 
})
