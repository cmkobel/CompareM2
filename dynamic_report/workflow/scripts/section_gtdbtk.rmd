...
`rule gtdbtk` [GTDB](https://gtdb.ecogenomic.org/) uses several public repositories with reference sequences and assigns the most likely name by measuring the average nucleotide identity (ANI) and relative evolutionary divergence (RED).
