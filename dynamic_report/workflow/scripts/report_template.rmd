...
if (debug) {
    ...
    base_variable = "~/evo/comparem2"
    output_directory = "results_comparem2"
    setwd("~/comparem2/tests/strachan_campylo")
    setwd("~/evo/comparem2/tests/MAGs/")
    ...
    base_variable = "~/comparem2"
    output_directory = "results_comparem2"
    setwd("~/comparem2/tests/E._faecium_30")
    batch_title = basename(getwd())

    # MAGs on thylakoid
    base_variable = "~/comparem2"
    output_directory = "results_comparem2"
    setwd("~/comparem2/tests/MAGs")
    batch_title = basename(getwd())

    # MAGs on axodines
    base_variable = "~/axodines/comparem2"
    output_directory = "results_comparem2"
    setwd("~/axodines/comparem2/tests/MAGs")
    batch_title = basename(getwd())

    # synth rumen on axodines
    base_variable = "~/axodines/comparem2"
    output_directory = "results_comparem2"
    setwd("~/axodines/comparem2/tests/synth_rumen")
    batch_title = basename(getwd())
    ...
    base_variable = "~/comparem2"
    output_directory = "results_comparem2"
    setwd("~/comparem2/tests/synth_rumen")
    batch_title = basename(getwd())
    ...
    # busco on mac
    base_variable = "~/comparem2/"
    output_directory = "results_comparem2_fixstr_busco"
    setwd("~/comparem2/")
    batch_title = basename(getwd())
...
`r paste0("This report was generated on ", Sys.time(), " using CompareM2 v", version_string, " based at ", base_variable, ". Content in this report is dynamically rendered based on the results located at", current_dir, ".")`
...
<p class = "shaded">[CompareM2 v`r version_string`](https://github.com/cmkobel/comparem2) genomes-to-report pipeline. Copyright (C) 2019-2024 [C. M. Kobel](https://github.com/cmkobel) GNU GPL v3</p>
