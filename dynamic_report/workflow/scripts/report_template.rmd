...
section_definition_table = tribble(
    ...
    "gapseq",            N, Sys.glob(paste0(output_directory, "/samples/*/gapseq/*-all-Pathways.tbl")),
...
```{r section_gapseq, child = paste0(report_scripts, "section_gapseq.rmd"), eval = render$gapseq}
```
