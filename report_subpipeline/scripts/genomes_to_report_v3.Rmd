...
custom_dt = function(x, filename = "viewer_", dom = "Blfrtip", ordering = T) {
    DT::datatable(
        ...
        options = list(
            ...
            buttons = list(
                'copy',
                list(extend = "csv", filename = paste(batch_title, filename, sep = "_")),
                list(extend = "excel", filename = paste(batch_title, filename, sep = "_"))
            )
        ),
        rownames = F,
        extensions = 'Buttons',
...
Licensed under [GNU GPL v3](https://github.com/cmkobel/assemblycomparator2/blob/master/LICENSE)