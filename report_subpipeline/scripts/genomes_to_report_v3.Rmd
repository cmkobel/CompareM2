...
custom_dt = function(x, filename = "viewer_", dom = "Blfrtip", ordering = T) {
    ...
    name = paste(batch_title, filename, sep = "-")
...
*Table `r tableno()`: Overview of sections that are rendered in this report. "n / expected" shows the number of analysis files versus how many are expected to be present. When any files are present for an section, the section will be rendered.*
