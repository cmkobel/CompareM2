...
section_definition_table = tribble(
    ...
    #"roary_summary",             1, Sys.glob(paste0(results_directory, "/roary/summary_statistics.txt")),
...
section_definition_table %>%
    ...
    custom_dt("sections", dom = "t", ordering = F)
...
*Table `r tableno()`: Overview of sections that are rendered in this report. "n / expected" shows the number of analysis files versus how many are expected to be present. Sections are only rendered if relevant files exist.*
