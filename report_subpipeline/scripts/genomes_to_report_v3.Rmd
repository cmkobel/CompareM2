...
custom_dt = function(x, filename = "viewer_", dom = "Blfrtip", ordering = T) {
    ...
    write_tsv(x, paste0(results_directory, "/collected_results/", name, ".tsv")) # Save a copy on the harddisk for people without browsers.
...
section_definition_table = tribble(
    ...
    "kraken2",           N, Sys.glob(paste0(results_directory, "/kraken2/kraken2_report.tsv")),
