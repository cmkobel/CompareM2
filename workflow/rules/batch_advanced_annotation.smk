...
rule kegg_pathway:
    input: 
        ...
        eggnog_annotations = expand("{results_directory}/samples/{sample}/eggnog/{sample}.emapper.annotations", sample = df["sample"], results_directory = results_directory)
    output: 
        pathway_enrichment = "{results_directory}/kegg_pathway/kegg_pathway_enrichment_analysis.tsv"
    params:
